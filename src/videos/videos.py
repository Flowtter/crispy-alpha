...
def create_video_object_from_frames_processed(tuples_processed, offset_start,
                                              offset_end, video_size_in_frame,
                                              name):
    videos_objects = []
...
def remove_overlap_videos_objects(video_obj1: video_object,
                                  video_obj2: video_object):
